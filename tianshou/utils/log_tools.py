...
if __name__ == "__main__":
    ...
    parser.add_argument('--dir', type=str, default='/home/huayu/git/tianshou/examples/mujoco/stepcollector10seed/HalfCheetah-v3/td3')
    parser.add_argument('--suffix', type=str, default='HalfCheetah_v3_td3')
